...
public class Game {
    ...
    public void playGame(Team init_home, Team init_away, League init_league, int[] homeInts, int[] awayInts) throws IOException {
        ...
        System.out.println("\n\n");
        printLog("Baseball Simulator. In today's game we have the " + home + " versus the " + away + ".\n");
        System.out.println("\n\n");


        Outcomes diamond = new Outcomes();

        while ( inning < 10) {
            printLog("Top of the " + inning + ". " + home + ": " + hRuns + " " + away + ": " + aRuns + "\n\n");
            ...
            System.out.println("\n");
            printLog("Bottom of the " + inning + ". " + home + " has " + hRuns + " runs, " + away + "has " + aRuns + " runs. \n\n");
